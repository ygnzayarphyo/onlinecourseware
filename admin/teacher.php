...
<body>  
<h1><a href="home.php">Admin Panel</a> -> Teacher</h1>
<div class='wrapper'>
    <label for="filter">Filter</label> <input type="text" name="filter" value="" id="filter" />
	<form action="deactivateteach.php" method="post">
    <table cellpadding="1" cellspacing="1" id="resultTable">
		...
		<?php
			...
			include('../db.php');
			$results = mysql_query("SELECT * FROM teacher WHERE mem_status='active'");
			...
			<td>'.$rows['contact'].'</td>
			<td>'.$rows['username'].'</td>
			<td><a rel="facebox" href="editt.php?id='.$rows['id'].'">edit</a></td>
			</tr>';
			}
		?>
        </tbody>
