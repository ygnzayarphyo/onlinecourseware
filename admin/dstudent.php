...
<body> 
<h1><a href="home.php">Admin Panel</a> -> Deactivated Students</h1> 
<div class='wrapper'>
    <label for="filter">Filter</label> <input type="text" name="filter" value="" id="filter" />
	<form action="activatestud.php" method="post">
    <table cellpadding="1" cellspacing="1" id="resultTable">
		...
		<?php
			...
			include('../db.php');
			$results = mysql_query("SELECT * FROM student WHERE mem_status='inactive'");
